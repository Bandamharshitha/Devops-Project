...
📂 The complete test case sheet can be found here:  
[Test Cases.xlsx](https://github.com/user-attachments/files/22002648/Test.Cases.xlsx)
...
| TC-04        | Hospital Portal    | Login with incorrect credentials          | Error message “Invalid credentials” shown   | Medium   |
| TC-05        | Live Alerts        | Trigger emergency alert from backend      | Alert is displayed on the dashboard in real-time | High |
